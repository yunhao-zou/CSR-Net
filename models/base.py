...
class BaseNet(nn.Module):
    def __init__(self, crf, crf_channel, n_bands, nclass, backbone, aux, se_loss, dilated=True, norm_layer=None,
        ...
        if backbone == 'resnet50':
            self.pretrained = resnet50(pretrained=False, dilated=dilated,
                                              norm_layer=norm_layer, root=root,
                                              multi_grid=multi_grid, multi_dilation=multi_dilation, crf=crf, crf_channel=crf_channel, n_bands=n_bands, num_classes=nclass)
        elif backbone == 'resnet101':
            self.pretrained = resnet101(pretrained=False, dilated=dilated,
                                               norm_layer=norm_layer, root=root,
                                               multi_grid=multi_grid,multi_dilation=multi_dilation, crf=crf, crf_channel=crf_channel, n_bands=n_bands, num_classes=nclass)
            ...
            self.pretrained = resnet18(pretrained=False, dilated=dilated,
                                               ...
                                               multi_grid=multi_grid, multi_dilation=multi_dilation, num_classes=nclass)
